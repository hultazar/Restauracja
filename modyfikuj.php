...
{
$_SESSION["modyfikuj"] = $_POST['modyfikuj'];
}
?>
<html lang="pl">    
                        ...
                        }else if (isset($_POST["datar"])) 
						{
							...
							if ($result->num_rows > 0) 
							{
								...
								while ($row = $result->fetch_assoc()) {
									echo '<tr>'
									. '<td>' . $row["tytul"] . '</td>'
									. '<td><form method="post" action="fun_modyfikuj.php"><button type="submit" value="' . $row["id_stolika"] . '" name="rezerwuj" ><strong>Rezerwuj</strong></button></form></td>'
									. '</tr>';
								}
								echo '</tbody></table>';
							}else{
