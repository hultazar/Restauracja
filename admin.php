...
<div class="wrapper">
    ...
    <?php
                    if (isset($_SESSION["user"])) {
						...
						echo '<form method="post" action="adminp.php"><button type="submit" value="1" name="niepotwierdzone" ><strong>Pokaż tylko niepotwierdzone</strong></button></form>';
						$dzisiaj =date("Y-m-d");
                        ...
                        if ($conn->connect_error) {
							...
							$sql = "select login, email, id_rezerwacji, czy_potwierdzona, "
                                ...
                                . "natural join klienci WHERE data_rezerwacji > '$dzisiaj' order by data_rezerwacji ASC";
